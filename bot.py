...
Ответ должен быть user friendly можно использовать иконки/эмоджи и ответ должен быть структурированным.
Каждый тикер должен содержать стоимость на сегодня
Язык отчета – русский.
'''
